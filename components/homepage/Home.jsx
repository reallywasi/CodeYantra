...
//             <motion.div
//               key={index}
//               className="bg-gray-100 p-8 rounded-lg shadow-lg text-center flex flex-col items-center"
//               initial={{ opacity: 0, y: 50 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ delay: index * 0.3, duration: 0.6, ease: "easeOut" }}
//               whileHover={{ scale: 1.05, rotate: 2, boxShadow: "0px 12px 24px rgba(0, 0, 0, 0.2)", transition: { duration: 0.3 } }}
